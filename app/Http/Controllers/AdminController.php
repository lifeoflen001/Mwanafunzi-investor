...
class AdminController extends Controller
{
    ...
    public function productEdit(Product $product) { return view('admin.products.form', ['product' => $product->load(['features', 'versions', 'faqs', 'images']), 'media' => Media::orderBy('filename')->get(), 'action' => route('admin.products.update', $product)]); }
