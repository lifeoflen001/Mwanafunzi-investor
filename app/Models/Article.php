...
class Article extends Model
{
    ...
    protected $fillable = ['article_category_id', 'user_id', 'title', 'slug', 'excerpt', 'content', 'featured_image', 'author', 'published_at', 'reading_time', 'status', 'is_featured', 'seo_title', 'seo_description', 'og_image', 'canonical_url', 'robots', 'og_title', 'og_description'];
