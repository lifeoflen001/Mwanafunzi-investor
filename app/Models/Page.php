...
class Page extends Model
{
    ...
    protected $fillable = ['key', 'slug', 'name', 'page_type', 'status', 'is_visible', 'hero_eyebrow', 'hero_title', 'hero_summary', 'hero_image', 'hero_overlay', 'hero_alignment', 'seo_title', 'seo_description', 'published_at'];
