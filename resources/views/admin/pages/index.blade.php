...
@section('content')
<div class="admin-heading"><div><p class="eyebrow">Website / Pages</p><h1>Pages</h1><p>Manage page identity, hero content, visibility and SEO without editing templates.</p></div><a class="button button-dark" href="{{ route('admin.pages.create') }}">Add page <span aria-hidden="true">↗</span></a></div>
