...
<form class="admin-filter-row" method="get" action="{{ route('admin.messages') }}">
    ...
    <button class="button button-light" type="submit">Filter</button>@if($term || request('status'))<a class="back-link" href="{{ route('admin.messages') }}">Clear</a>@endif
</form>
<div class="admin-table admin-message-table">
